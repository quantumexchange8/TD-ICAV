                            ...
                            <div class="sidebar__widget" data-aos="fade-up" data-aos-duration="1800">
                                ...
                                <div class="sidebar__list">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="sidebar__common__input" href="#">Retirement Planning
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                        <div class="service__details__wraper">
                            ...
                            <div class="service__details__text" data-aos="fade-up" data-aos-duration="1500">
                                <p>The supply of well-balanced assets, profit sharing, and secure investments are the sole components of our retirement plan services, which are entirely committed to these aspects. Oversight and compliance with regulatory requirements are important. The establishment of a fiduciary process that is Reiter-able, defendable, and recorded is something that we strive to do. </p>
                                <p>Our staff will aid in insuring that your committee adheres to the required fiduciary standards of care and complies with all regulating laws of ERISA. Investing is the major focus of our attention. We make sure that our strategic planning takes into account the most recent developments in asset analysis and investment fund performance monitoring. This is the case regardless of whether the investment plan is an established one or a new one. </p>
                                <p>On an annual basis, we do due diligence on hundreds of start-up firms and choose around two percent of them to be considered for investment. Following this, both our institutional investors and our individual investors are sent an invitation to choose the start-up businesses that have piqued their interest for the purpose of an investment. The minimum amount of money that an individual investor can afford to invest is generally $10,000, with the average investment amount being $30,000. We invest according to the same terms of investment that we use for our investors that we use for ourselves.</p>
