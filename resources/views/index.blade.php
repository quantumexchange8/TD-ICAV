...
@section('content')
    ...
    <div class="service sp_top_100 sp_bottom_140 special__spacing" id="service__area" style="background: var(--pinkcolor) url(img/service/service__bg__3.png);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="1500">
                    <div class="service__single__4 single__transform">
                        <div class="service__img__4">
                        ...
                        <div class="service__icon">
                            <a class="direction__btn"><svg width="34" height="34"
                                    ...
                                    <path d="M10.9902 23.0107L22.8908 11.1101" stroke="#0A0624" stroke-width="1.5"
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="1800">
                    <div class="service__single__4 single__transform">
                        <div class="service__img__4">
                            <img src="img/service/service__10.png" alt="">
                        </div>
                        <div class="service__heading__4">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up" data-aos-duration="2100">
                    <div class="service__single__4 single__transform">
                        <div class="service__img__4">
                            <img src="img/service/service__11.png" alt="">
                        </div>
                        <div class="service__heading__4">
            ...
            <div class="row position-relative">
                <div class="team__slider__active swiper">
                    <div class="swiper-wrapper">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-12 swiper-slide align-self-stretch" data-aos="fade-up" data-aos-duration="1800">
                            <div class="blog__2__wrapper common__gradient__bg single__transform h-100">
                                <div class="blog__2__inner d-flex flex-column h-100">
                                    <div class="blog__2__heading">
                                        <h3><a href="/portfolios">FINANCIAL PLANNING PORTFOLIO</a></h3>
                                    </div>
                                    <div class="blog__2__text flex-grow-1">
    ...
    <div class="about ext-about position-relative sp_top_100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="1800">
                    <div class="faq__area sp_top_50 sp_bottom_140">
                        <div class="container">
                                ...
                                <div id="panelsStayOpen-collapseNine" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingNine">
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <div class="accordion__text">
                                                <p>A client is able to evaluate their path to retirement and determine the projection of future income from existing assets and savings when they have a financial plan in place. 
                                                    Making sure that your wealth is safeguarded and managed for the future 
                                                    Our discretionary managed portfolio service was developed with the intention of ensuring that each and every one of our clients is treated in an equitable manner. 
                                                </p>
                                            </div> 
                                            </div>
                                        </div>
