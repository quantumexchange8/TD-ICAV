                        ...
                        <div class="service__details__sidebar sidebar">
                            ...
                            <div class="sidebar__widget" data-aos="fade-up" data-aos-duration="1800">
                                ...
                                <div class="sidebar__list">
                                    <ul>
                                        <li>
                                            <a class="sidebar__common__input" href="#">THE DEVELOPMENT OF BUSINESSES
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="sidebar__common__input" href="#">ENGINEERING AND TECHNOLOGY
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="sidebar__common__input" href="#">FACILITIES TEAM
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="sidebar__common__input" href="#">FINANCE TEAM
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="sidebar__common__input" href="#">HUMAN RESOURCES
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="sidebar__common__input" href="#">COMPLIANCE AND LEGAL ISSUES
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="sidebar__common__input" href="#">ADVERTISING AND MARKETING
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="sidebar__common__input" href="#">OPERATIONS
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="sidebar__common__input" href="#">INVESTMENT IN PORTFOLIOS
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="sidebar__common__input" href="#">EXECUTION OF STRATEGIES FOR THE PORTFOLIO
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="sidebar__common__input" href="#">CONDUCTING AN INVESTIGATION
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="sidebar__common__input" href="#">THE MANAGEMENT OF RISK
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="sidebar__common__input" href="#">GLOBAL TRADING STRATEGIES TEAM
                                                <i class="icofont-rounded-right"></i>
                                            </a>
                                        </li>
                                    </ul>
