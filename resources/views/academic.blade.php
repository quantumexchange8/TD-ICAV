            ...
            <div class="col-xl-12" data-aos="fade-up" data-aos-duration="1500">
                <div class="breadcrumbarea__content__wraper">
                    <div class="breadcrumbarea__title">
                        <h2 class="heading">Academic Activities and Participation</h2>
                    </div>
                    <div class="breadcrumbarea__inner">
                        <ul>
                            ...
                            <li>// </li>
                            <li> Academic Activities and Participation</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="about__inner about__inner--2">
                    <div class="section__title section__title--2  sp_bottom_10">
                        ...
                        <div class="about__text__2 ">
                            ...
                            <p>We push for knowledge because we believe that our customers, our community, and our employees can all benefit from collective wisdom. In order to create connections between consumers and the most inventive specialists in the area, we cooperate with universities to encourage the development of the future generation of talent. Additionally, we arrange events to facilitate connections between universities and customers. We are confident that we can assist our customers in making better informed investment decisions, which ultimately contributes to their success.</p>
                        </div>
                    </div>
                </div>
            </div>
