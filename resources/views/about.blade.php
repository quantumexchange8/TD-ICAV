...
@section('content')
        ...
        <!-- approach -->
        <div class="skillarea sp_bottom_110 sp_top_100" style="background: url(img/blog/blog__bg_2.png);">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12 col-12"  data-aos="fade-up" data-aos-duration="1500">
                        <div class="section__title  section__title--2 blog__4__padding__right section__title--3">
                            <div class="section__title__button">
                                <span>Our Approach to Methodology: The Investment Process </span>
                            </div>
                            <div class="section__title__heading sp_bottom_20">
                                <div class="blog__4__section__title__text">
                                <p>Both the Intuition of the Economy and the Insights from Research Support a Novel Approach to Systematic investing.</p>
                                </div>
