...
<div class="col-xl-8 col-lg-8 col-md-12 col-12 content-section" id="portfolio2" >
    <div class="service__details__wraper">
        ...
        <div class="service__details__planning__inner service__details__text" data-aos="fade-up" data-aos-duration="1500">
            <h6>DIFFERENT TYPES OF ADVISORY PROGRAMS </h6>
            ...
            <h6>THE OPTIONS FOR INVESTMENT</h6>
            ...
            <h6>THE BEST OPTIONS TO MAKE </h6>
            ...
            <h6>ULTRA-PERSONALIZED GOALS </h6>
...
<div class="col-xl-8 col-lg-8 col-md-12 col-12 content-section" id="portfolio3">
    <div class="service__details__wraper">
        ...
        <div class="service__details__planning__inner service__details__text" data-aos="fade-up" data-aos-duration="1500">
            ...
            <h6>MINIMUM RISK PORTFOLIO WITH PORTFOLIO </h6>
            ...
            <h6>PORTFOLIO OF RISKS THAT ARE MEDIUM </h6>
            ...
            <h6>A PORTFOLIO WITH HIGH RISK </h6>
            ...
            <h6>PLANTS FOR INVESTMENT THAT ARE STRUCTURED </h6>
...
<div class="col-xl-8 col-lg-8 col-md-12 col-12 content-section" id="portfolio4">
    <div class="service__details__wraper">
        ...
        <div class="service__details__planning__inner service__details__text" data-aos="fade-up" data-aos-duration="1500">
            ...
            <h6>DETAILED PORTFOLIO OF WORK </h6>
            <p>Investing in a wide range of assets will help you achieve portfolio diversification. For the purpose of providing you with high-quality alternatives, we conduct an analysis of the whole universe of stocks, bonds, and mutual funds.</p> 
            <h6>INVESTMENTS UNDER SECURITY  </h6>
            <p>A significant number of investors consider retirement and education savings to be among their most important financial goals. For your convenience, we provide a wide range of investment opportunities that might potentially be profitable. </p>
            <h6>Advisor on Financial Matters, PARTER </h6>
            <p>In order to accomplish your long-term investing goals, you are ready to accept the possibility of experiencing higher losses in the short term and are at ease with the idea of putting a greater proportion of your cash at risk. Additionally, you are intrigued in the possibility of earning substantial returns on your investment. In general, your portfolio will contain a very high proportion of investments in equities and a very low proportion of investments in fixed income stocks and bonds. It is quite likely that your portfolio will be subject to market volatility that falls anywhere between moderate and high level. </p>
            <h6>PLANTS FOR INVESTMENT THAT ARE STRUCTURED </h6>
            <p>The goods and services that we offer in the realm of investments have the ability to turn your goals into measurable outcomes. Creating a portfolio that is well-diversified is something that may be accomplished via collaboration with your financial adviser.</p>
            <h6>A CERTAINTY IN THE FUTURE OF YOUR FINANCIAL ESTATE </h6>
            <p>The process of developing your own personal financial plan may be broken down into just three simple steps: </p>
            <p>Before anything else, kindly speak with us: </p>
            <p>1. Make sure that your planner is aware of your goals, issues, and requirements. They serve as the basis for your personal financial plan, which is intended to assist you in achieving the goals that you have set for yourself. Your planner is eager to hear what you have to say, and the floor is fully yours.</p>
            <p>2. Collaborate: Your financial plan will be carried out in partnership with your adviser, and you will be provided with frequent updates on its progress. In order for them to be able to make the required modifications and continue to build on your success in order to retain your goals, it is your obligation to tell them of any changes in your priorities or life events that may occur.</p>
            <p>3. After that, relax on the sofa: Any time you need our assistance, we are here to provide it. If you have any questions or concerns, please do not hesitate to get in touch with us at any time.</p>
        </div>
    </div>
</div>
