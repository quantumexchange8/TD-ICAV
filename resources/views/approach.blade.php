        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" data-aos="fade-up" data-aos-duration="2100">
                    ...
                    <div class="blog__details__img__wrapper" data-aos="fade-up" data-aos-duration="1500">
                        <div class="blog__details__list" data-aos="fade-up" data-aos-duration="1500">
                            <ul>
                                ...
                                <li>"No single idea will do the trick," according to their perspective, "but each of these can help investors get closer to the 5% real-return target." 
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="about__inner about__inner--2">
                    <div class="section__title section__title--2 sp_bottom_10">
                        <div class="section__title__button">
                            <h4 class="text__gradient">Carried Out in a Methodical Manner</h4>
                        </div>
                        <div class="blog__details__img__wrapper" data-aos="fade-up" data-aos-duration="1500">
                            <p>A methodological framework guides every action we take. Our team at TD-ICAV has utilized a continuous cycle of design, refinement, testing, and repetition over the course of 20 years to create our models.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="about__inner about__inner--2">
                    <div class="section__title section__title--2 sp_bottom_10">
                        <div class="section__title__button">
                            <h4 class="text__gradient">Systematic versus Open to Personal Choice</h4>
                        </div>
                        <div class="blog__details__img__wrapper" data-aos="fade-up" data-aos-duration="1500">
                ...
                <div class="about__inner about__inner--2">
                    <div class="section__title section__title--2 sp_bottom_10">
                        <div class="section__title__button">
                            <h4 class="text__gradient">Crafted with Outstanding Attention to Detail</h4>
                        </div>
                        <div class="blog__details__img__wrapper" data-aos="fade-up" data-aos-duration="1500">
