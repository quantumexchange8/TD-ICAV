                ...
                {{-- <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="sidebar__widget" data-aos="fade-up" data-aos-duration="1500">
                            <div class="sidebar__search">
                                <form action="#" style="position: relative;">
                                    ...
                                    <button class="sidebar__search__button">
                    ...
                    <div class="sidebar__widget" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <div class="sidebar__post">
                            ...
                            <li>
                                    <a href="#">
                                        ...
                                        <img src="img/blog/blog__small__1.png" alt="">
                                        </div> 
                                        <div class="sidebar__post__text">
                                        <h6>Sodales neque sodales and etiam nulla magna</h6>
                                        <span class="text__gradient">02 June, 2024</span>
                                        </div>
                                    </a>
                            </li>
                            ...
                            <li>
                                <a href="#">
                                    <div class="sidebar__post__img">
                                    <img src="img/blog/blog__small__2.png" alt="">
                                    </div> 
                                    <div class="sidebar__post__text">
                                    <h6>Sodales neque sodales and etiam nulla magna</h6>
                                    <span class="text__gradient">02 June, 2024</span>
                        ...
                        <li>
                            <a href="#">
                                <div class="sidebar__post__img">
                                <img src="img/blog/blog__small__3.png" alt="">
                                </div> 
                                <div class="sidebar__post__text">
                                <h6>Sodales neque sodales and etiam nulla magna</h6>
                                <span class="text__gradient">02 June, 2024</span>
                    ...
                    <div class="sidebar__widget" data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <div class="sidebar__tag">
                            <ul>
                                <li>
                                    <a class="common__gradient__bg active" href="#">
                                        <span>Management</span>
                                    </a>
                                </li>

                                <li>
                                    <a class="common__gradient__bg " href="#">
                 ...
                 <!-- featured contents -->
                 @include('featured.featured-contents')
            </div>
        </div>
    </div>
