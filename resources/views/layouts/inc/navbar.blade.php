                    ...
                    <div class="headerarea__main__wrapper headerarea__main__wrapper--3 position-relative">
                        <div class="headerarea__component__wrap">
                            <div class="headerarea__component">
                                ...
                                <a href="/">
                                    <img src="img\company logo\TD-landscape-white.png" alt="Logo">
                                </a>
                                </div>
                            </div>
                            <div class="headerarea__component">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="mobile__log">
                            <div class="mobile__log--title"><a class="mobile__log--link" href="/">
                                <img class="mobile__log--img" src="img\company logo\TD-landscape-white.png" alt="logo-img">
                            </a></div>
                        </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="/">
                        <img src="img\company logo\TD-landscape-color.png" alt="Logo-img">
                    </a>
                    ...
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li"><a href="/career" class="offcanvas__sub_menu_item">Strategies & Methodologies</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="/career" class="offcanvas__sub_menu_item">Career</a></li>
                                <li class="offcanvas__sub_menu_li"><a href="/career" class="offcanvas__sub_menu_item">Academic Activities and Participation</a></li>
                            </ul>
                        </li>
                        <li class="offcanvas__menu_li">
