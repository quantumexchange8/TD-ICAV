                        ...
                        <div class="headerarea__component">
                            <div class="headerarea__right">
                                <div class="headerarea__button">
                                    <a class="default__button btn__white" href="https://app.tdicav.org/accounts/login">LOGIN</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="offcanvas__inner">
            ...
            <nav class="offcanvas__menu">
                ...
                <div class="offcanvas__account--items">
                    <a class="offcanvas__account--items__btn d-flex align-items-center" href="https://app.tdicav.org/accounts/login">
