                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="accordion__text">
                                                    <p>A significant amount of time before the events that transpired in 2008, the investment team at TD-ICAV had already built the instruments that were required to recognize and analyze economic crises. The following statements are made by key members of the investment team on the ways in which this approach led to extremely important decisions and insights, and the strategies that TD-ICAV utilized in order to effectively manage the financial crisis that occurred in 2008. According to the persons who were in charge of guiding TD-ICAV through the financial crisis, here is the story of how the company rose through the crisis. </p>
                                                    <p>We had a conversation with the founder of TD-ICAV and Jim Haskel, a senior portfolio strategist, who elaborated on some of the most important studies we have conducted on debt crises and related them to the current state of the market. The conversation focused on the current state of the market. </p>
                                                    <p>Downloadable versions of our book, "Big Debt Crises," are currently available. This book provides a unique framework for understanding the mechanics of debt crises as well as the concepts that may be utilized to effectively handle them. The book bears the title Concepts for Navigating Big Debt Crises. To acquire further information, please download the free PDF. </p>
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="panelsStayOpen-headingNine">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseNine" aria-expanded="false" aria-controls="panelsStayOpen-collapseNine">
                                            Is the incident that occurred on July 26th 2007 significant? 
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="panelsStayOpen-collapseSixteen" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSixteen">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="accordion__text">
                                                    <p>The Federal Reserve and the Treasury Department announced the purchase of assets and the provision of loans totaling $800 Billion. The purpose of these actions was to lower mortgage rates in order to provide support for the housing market. This was the first quantitative easing (QE) program they ever implemented. This was a crucial and necessary measure in administering a deleveraging process. Central bankers must choose between: </p>
                                                <ul>
                                                    <li>"printing" extra money (above the necessary amount for bank liquidity) to counteract the decline in private credit </li><br>
                                                    <li>allowing a severe contraction when credit collapses during times of crisis. </li><br>
                                                </ul>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="panelsStayOpen-collapseSeventeen" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSeventeen">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="accordion__text">
                                                    <p>The Federal Reserve began purchasing Treasury bonds in addition to increasing its purchases of mortgage-backed securities (MBS). </p>                                               
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
